...
class IsaacGym(BaseSimulator):
    ...
    def get_dof_limits_properties(self):
        ...
        for i in range(self.num_dof):
            print(f"DOF {i} velocity limits from isaacgym: lower {self.dof_vel_limits[i].item()}, upper {self.robot_config.dof_vel_limit_list[i]}")
        
        for i in range(self.num_dof):
            print(f"DOF {i} velocity limits from isaacgym: lower {self.torque_limits[i].item()}, upper {self.robot_config.dof_effort_limit_list[i]}") 
