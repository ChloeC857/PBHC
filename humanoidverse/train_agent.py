...
def main(config: OmegaConf):
    """
    Main training pipeline for RL agents.
    
    Steps:
        1. Detect and initialize simulator (IsaacSim/IsaacGym)
        2. Setup logging (file + console + WandB)
        3. Create training environment
        4. Instantiate algorithm and load checkpoint (if provided)
        5. Run training loop
    
    Args:
        config: Hydra configuration with training parameters
    """
    # ============================================================================
    # Detect simulator type from config and initialization
    # ============================================================================
    ...
    if simulator_type == 'IsaacSim':
        ...
        # Parse arguments and configure simulator
        ...
        args_cli.headless = config.headless  # Run without GUI
        
        # Launch IsaacSim application
        app_launcher = AppLauncher(args_cli)
        simulation_app = app_launcher.app  
    
    # Initialize IsaacGym (standalone)
    ...
    # All events will be saved to train.log
    hydra_log_path = os.path.join(HydraConfig.get().runtime.output_dir, "train.log")
    logger.remove()
    logger.add(hydra_log_path, level="DEBUG")

    # Console logging: configurable level via LOGURU_LEVEL env variable
    ...
    # ============================================================================
    # Process configuration and select device
    # ============================================================================
    ...
    # ============================================================================
    # Initialize algorithm and run training task
    # ============================================================================
    
    # Instantiate RL algorithm, networks, optimizers, buffers
